...
export default function HomePage() {
  return (
    <main className="flix-col min-h-screen items-center justify-center p-24 bg-slate-950 text-white">
      <h1 className="text-6xl font-bold mb-4">DeepResearch</h1>
      <p className="text-xl text-slate-400 mb-8 max-w-2l| text-center">
